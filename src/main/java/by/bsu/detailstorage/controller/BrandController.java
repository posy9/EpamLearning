...
public class BrandController extends AbstractController<Brand, BrandReadDto, BrandCreateDto> {

    public BrandController(ModelMapper modelMapper, BrandService service) {
        super(modelMapper, service, Brand.class, BrandReadDto.class);
    }
}
